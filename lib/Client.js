...
var Client = (function () {
  ...
  _createClass(Client, [{
    ...
    value: function range(queue) {
      var startI = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
      var endI = arguments.length <= 2 || arguments[2] === undefined ? -1 : arguments[2];

      return this.ioredis.lrange(queue, startI, endI).then(function (items) {
